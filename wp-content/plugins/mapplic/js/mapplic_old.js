...
jQuery(document).ready(function($) {
	...
	$("#prints").click(function () {
        ...
        frameDoc.document.write('<script type="text/javascript">var doc = new jsPDF("landscape"); var specialElementHandlers = { "#editor": function (element, renderer) { return true; } }; $("#pdf-btns").click(function () { doc.fromHTML($("#myPDF").html(), 15, 15, { "width": "750" , "elementHandlers": specialElementHandlers } ) ;  doc.save("sample-file.pdf"); });</script>');
