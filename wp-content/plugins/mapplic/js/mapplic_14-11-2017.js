...
jQuery(document).ready(function() {
    ...
    $("body").on('click', '#prints', function() {    	
        ...
        frame1.css({"position": "absolute","border": "1px solid black","border-collapse": "collapse","width": "100%"});
        $("body").append(frame1);
