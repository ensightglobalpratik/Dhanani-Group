...
jQuery(document).ready(function() {
    ...
    $("body").on('click', '#prints', function() {
        ...
        frameDoc.document.write('<style>  strong { font-weight: 700; } table { width: 100%; }  table, th, td { border: 1px solid black; border-collapse: collapse; }.btn{background: #f0750f; display: inline-block; vertical-align: top; color: #fff !important; text-align: center; line-height: 1; font-weight: 900; text-transform: uppercase; padding: 10px 24px 10px; font-family: "Lato", sans-serif; cursor:pointer; margin-top:10px;} .btn:hover { background: #008af0; color: #fff;} </style>');
        frameDoc.document.write('</head><body>');
        frameDoc.document.write('<div id="myPDF" >');
        //Append the external CSS file.
        //Append the DIV contents.
        frameDoc.document.write(contents);
        frameDoc.document.write('<div style="text-align:center;"><button class="btn btn-sm pull-right btn-default" id="print-btns">Print</button> <button class="btn btn-sm pull-right btn-default pdf-btns" id="pdf-btns">Save As PDF</button> </div></body></html>');
        ...
        frameDoc.document.write('<script type="text/javascript">var doc = new jsPDF("landscape"); var specialElementHandlers = { "#editor": function (element, renderer) { return true; } }; $("body").on("click",".pdf-btns",function (){doc.fromHTML($("#myPDF").html(), 15, 15, { "width": "750" , "elementHandlers": specialElementHandlers } ) ;  doc.save("sample-file.pdf"); });</script>');
        frameDoc.document.close();
        /*
                 frameDoc.document.write('<div style="text-align:center;"><button class="btn btn-sm pull-right btn-default" id="print-btns">Print</button> <button class="btn btn-sm pull-right btn-default" id="pdf-btns">Save As PDF</button> </div></body></html>');
        frameDoc.document.write("</div>");
        frameDoc.document.write("<script src=\'https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js\'><\/script>");
        frameDoc.document.write('<script src=\"https://unpkg.com/jspdf@latest/dist/jspdf.min.js\"></script>');
        frameDoc.document.write('<script type="text/javascript">$(document).ready(function($) {$("#print-btns").click(function () {$("#print-btns").hide(); $("#pdf-btns").hide(); window.print(); });  });</script>');        
        frameDoc.document.write('<script type="text/javascript">var doc = new jsPDF("landscape"); var specialElementHandlers = { "#editor": function (element, renderer) { return true; } }; $("#pdf-btns").click(function (){ preven doc.fromHTML($("#myPDF").html(), 15, 15, { "width": "750" , "elementHandlers": specialElementHandlers } ) ;  doc.save("sample-file.pdf"); });</script>');
        frameDoc.document.close();
        */
        setTimeout(function() {
...
/*jQuery(window).load(function() {
    $("body").on('click', '#prints', function() {
        ...
        frameDoc.document.write('<script src=\"https://unpkg.com/jspdf@latest/dist/jspdf.min.js\"></script>');
        frameDoc.document.write('<script type="text/javascript">$(document).ready(function($) {$("#print-btns").click(function () {$("#print-btns").hide(); $(".pdf-btns").hide(); window.print(); });  });</script>');
        frameDoc.document.write('<script type="text/javascript">var doc = new jsPDF("landscape"); var specialElementHandlers = { "#editor": function (element, renderer) { return true; } }; $("body").on("click",".pdf-btns",function (){ alert(); doc.fromHTML($("#myPDF").html(), 15, 15, { "width": "750" , "elementHandlers": specialElementHandlers } ) ;  doc.save("sample-file.pdf"); });</script>');
        frameDoc.document.close();
        /*
                 frameDoc.document.write('<div style="text-align:center;"><button class="btn btn-sm pull-right btn-default" id="print-btns">Print</button> <button class="btn btn-sm pull-right btn-default" id="pdf-btns">Save As PDF</button> </div></body></html>');
        frameDoc.document.write("</div>");
